...
public static class CloneExtensions
{
    ...
    public static Fluid Clone(this Fluid instance) => instance.DeepClone();
    ...
    public static Mixture Clone(this Mixture instance) => instance.DeepClone();
    ...
    public static HumidAir Clone(this HumidAir instance) => instance.DeepClone();
}