...
public partial class HumidAir
{
    ...
    private HumidAir DryHeatTransferTo(Temperature temperature, bool cooling,
        Pressure? pressureDrop = null)
    {
    ...
    private HumidAir DryHeatTransferTo(SpecificEnergy enthalpy, bool cooling,
        Pressure? pressureDrop = null)
    {
    ...
    private HumidAir WetCoolingTo(IKeyedInput<string> fistInput,
        IKeyedInput<string> secondInput, Pressure? pressureDrop = null)
    {
    ...
    private HumidAir HumidificationTo(IKeyedInput<string> fistInput,
        IKeyedInput<string> secondInput)
    {
        var result = WithState(InputHumidAir.Pressure(Pressure),
            fistInput, secondInput);
        return result.Humidity > Humidity
            ? result
            : throw new ArgumentException(
