...
public class AbstractState : global::System.IDisposable
{
    ...
    internal static global::System.Runtime.InteropServices.HandleRef swigRelease(AbstractState obj)
    {
        if (obj != null)
        {
            if (!obj.swigCMemOwn)
    ...
    public virtual string build_options_json()
    {
        string ret = CoolPropPINVOKE.AbstractState_build_options_json(swigCPtr);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    public virtual void update_QT_pure_superanc(double Q, double T)
    {
        CoolPropPINVOKE.AbstractState_update_QT_pure_superanc(swigCPtr, Q, T);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
    }
    ...
    public double Qmass()
    {
        double ret = CoolPropPINVOKE.AbstractState_Qmass(swigCPtr);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    public double hmolar_idealgas()
    {
        double ret = CoolPropPINVOKE.AbstractState_hmolar_idealgas(swigCPtr);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }

    public double hmass_idealgas()
    {
        double ret = CoolPropPINVOKE.AbstractState_hmass_idealgas(swigCPtr);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    public double smolar_idealgas()
    {
        double ret = CoolPropPINVOKE.AbstractState_smolar_idealgas(swigCPtr);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }

    public double smass_idealgas()
    {
        double ret = CoolPropPINVOKE.AbstractState_smass_idealgas(swigCPtr);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    public double neff()
    {
        double ret = CoolPropPINVOKE.AbstractState_neff(swigCPtr);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    public double umolar_idealgas()
    {
        double ret = CoolPropPINVOKE.AbstractState_umolar_idealgas(swigCPtr);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }

    public double umass_idealgas()
    {
        double ret = CoolPropPINVOKE.AbstractState_umass_idealgas(swigCPtr);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
