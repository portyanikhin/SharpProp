...
{
    public static string get_parameter_information(int key, SWIGTYPE_p_std__string_view info)
    {
        string ret = CoolPropPINVOKE.get_parameter_information(key, SWIGTYPE_p_std__string_view.getCPtr(info));
    ...
    public static bool is_valid_scheme(string scheme_name, SWIGTYPE_p_CoolProp__schemes iOutput)
    {
        bool ret = CoolPropPINVOKE.is_valid_scheme(scheme_name, SWIGTYPE_p_CoolProp__schemes.getCPtr(iOutput));
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }

    public static schemes get_scheme_index(string scheme_name)
    {
        schemes ret = (schemes)CoolPropPINVOKE.get_scheme_index(scheme_name);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    public static bool is_Qmass_pair(input_pairs p)
    {
        bool ret = CoolPropPINVOKE.is_Qmass_pair((int)p);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    public static void apply_simple_mixing_rule(string identifier1, string identifier2, string rule)
    {
        CoolPropPINVOKE.apply_simple_mixing_rule(identifier1, identifier2, rule);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
    }

    public static void set_interaction_parameters(string string_data)
    {
        CoolPropPINVOKE.set_interaction_parameters(string_data);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
    }
    ...
    {
        string ret = CoolPropPINVOKE.get_mixture_binary_pair_pcsaft(CAS1, CAS2, param);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    {
        CoolPropPINVOKE.set_mixture_binary_pair_pcsaft(CAS1, CAS2, param, val);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
    }
    ...
    public static VectorOfDoubleVector Props1SImulti(StringVector Outputs, string backend, StringVector fluids, DoubleVector fractions)
    {
        VectorOfDoubleVector ret = new VectorOfDoubleVector(CoolPropPINVOKE.Props1SImulti(StringVector.getCPtr(Outputs), backend, StringVector.getCPtr(fluids), DoubleVector.getCPtr(fractions)), true);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    public static void Skip_if_No_REFPROP()
    {
        CoolPropPINVOKE.Skip_if_No_REFPROP();
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
    }

    public static string config_key_to_string(SWIGTYPE_p_configuration_keys keys)
    {
        string ret = CoolPropPINVOKE.config_key_to_string(SWIGTYPE_p_configuration_keys.getCPtr(keys));
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }

    public static SWIGTYPE_p_configuration_keys config_string_to_key(string s)
    {
        SWIGTYPE_p_configuration_keys ret = new SWIGTYPE_p_configuration_keys(CoolPropPINVOKE.config_string_to_key(s), true);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }

    public static string config_key_description(SWIGTYPE_p_configuration_keys keys)
    {
        string ret = CoolPropPINVOKE.config_key_description__SWIG_0(SWIGTYPE_p_configuration_keys.getCPtr(keys));
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    public static bool get_config_bool(SWIGTYPE_p_configuration_keys key)
    {
        bool ret = CoolPropPINVOKE.get_config_bool(SWIGTYPE_p_configuration_keys.getCPtr(key));
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }

    public static int get_config_int(SWIGTYPE_p_configuration_keys key)
    {
        int ret = CoolPropPINVOKE.get_config_int(SWIGTYPE_p_configuration_keys.getCPtr(key));
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }

    public static double get_config_double(SWIGTYPE_p_configuration_keys key)
    {
        double ret = CoolPropPINVOKE.get_config_double(SWIGTYPE_p_configuration_keys.getCPtr(key));
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }

    public static string get_config_string(SWIGTYPE_p_configuration_keys key)
    {
        string ret = CoolPropPINVOKE.get_config_string(SWIGTYPE_p_configuration_keys.getCPtr(key));
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        return ret;
    }
    ...
    public static void set_config_bool(SWIGTYPE_p_configuration_keys key, bool val)
    {
        CoolPropPINVOKE.set_config_bool(SWIGTYPE_p_configuration_keys.getCPtr(key), val);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
    }

    public static void set_config_int(SWIGTYPE_p_configuration_keys key, int val)
    {
        CoolPropPINVOKE.set_config_int(SWIGTYPE_p_configuration_keys.getCPtr(key), val);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
    }

    public static void set_config_double(SWIGTYPE_p_configuration_keys key, double val)
    {
        CoolPropPINVOKE.set_config_double(SWIGTYPE_p_configuration_keys.getCPtr(key), val);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
    }

    public static void set_config_string(SWIGTYPE_p_configuration_keys key, string val)
    {
        CoolPropPINVOKE.set_config_string(SWIGTYPE_p_configuration_keys.getCPtr(key), val);
        if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
    }
