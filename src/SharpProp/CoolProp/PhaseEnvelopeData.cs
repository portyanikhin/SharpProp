...
public class PhaseEnvelopeData : global::System.IDisposable
{
    ...
    internal static global::System.Runtime.InteropServices.HandleRef swigRelease(PhaseEnvelopeData obj)
    {
        if (obj != null)
        {
            if (!obj.swigCMemOwn)
    ...
    public bool closed
    {
        set
        {
            CoolPropPINVOKE.PhaseEnvelopeData_closed_set(swigCPtr, value);
            if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
        }
        get
        {
            bool ret = CoolPropPINVOKE.PhaseEnvelopeData_closed_get(swigCPtr);
            if (CoolPropPINVOKE.SWIGPendingException.Pending) throw CoolPropPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
    }
