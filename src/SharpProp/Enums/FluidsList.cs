...
public enum FluidsList
{
    ...
    [FluidInfo("Helium")] R704,

    [FluidInfo("HFE143m")] HFE143m,

    [FluidInfo("HFE143m")] RE143a,

    [FluidInfo("Hydrogen")] Hydrogen,

    [FluidInfo("Hydrogen")] R702,
    ...
    [FluidInfo("n-Pentane")] R601,

    [FluidInfo("n-Propane")] nPropane,

    [FluidInfo("n-Propane")] R290,
    ...
    [FluidInfo("SulfurDioxide")] R764,

    [FluidInfo("SulfurHexafluoride")] SulfurHexafluoride,

    [FluidInfo("SulfurHexafluoride")] R846,
