...
public class HumidAirExtendedTests
{
    ...
    private readonly IHumidAirExtended _humidAir = new HumidAirExtended().WithState(
    ...
    public void SpecificHeatConstVolume_HumidAirInStandardConditions_Returns722() =>
        _humidAir.SpecificHeatConstVolume.JoulesPerKilogramKelvin.Should().Be(722.68718970632506);
    ...
    public void Methods_New_ReturnsInstancesOfInheritedType()
    {
        ...
        _humidAir
            ...
            .BeOfType<HumidAirExtended>();
        _humidAir
            .WetCoolingTo(_humidAir.Temperature - TemperatureDelta, LowRelativeHumidity)
            .Should()
            .BeOfType<HumidAirExtended>();
        _humidAir
            ...
            .BeOfType<HumidAirExtended>();
        _humidAir
            .WetCoolingTo(_humidAir.Enthalpy - EnthalpyDelta, LowRelativeHumidity)
            .Should()
            .BeOfType<HumidAirExtended>();
        _humidAir
        ...
        _humidAir
            ...
            .Should()
            .BeOfType<HumidAirExtended>();
        _humidAir.HumidificationByWaterTo(HighHumidity).Should().BeOfType<HumidAirExtended>();
        _humidAir
            .HumidificationBySteamTo(HighRelativeHumidity)
            .Should()
            .BeOfType<HumidAirExtended>();
        _humidAir.HumidificationBySteamTo(HighHumidity).Should().BeOfType<HumidAirExtended>();
        _humidAir
            .Mixing(
                100.Percent(),
                _humidAir.WetCoolingTo(_humidAir.Temperature - TemperatureDelta, LowHumidity),
                200.Percent(),
